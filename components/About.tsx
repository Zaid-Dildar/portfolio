...
export default function About() {
  ...
  return (
    ...
    >
      ...
      <p className="mb-3">
        After completing my Higher Secondary School education in
      ...
      <p>
        ...
        video games, watching movies, and playing physical sports. I also enjoy{" "}
        <span className="font-medium">learning new things</span>. I am currently
        learning about{" "}
        <span className="font-medium">history and philosophy</span>. I'm also
        very enthusiastic about football.
      </p>
    </motion.section>
  );
}
